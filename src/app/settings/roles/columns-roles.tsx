...
// Componente para la celda editable de Markup
const EditableMarkupCell = ({ row }: { row: any }) => {
  ...
  const handleSave = async () => {
    ...
    setMarkup(roundedPercentage.toFixed(2)); // También usamos toFixed aquí para la UX
