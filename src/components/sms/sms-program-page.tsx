      ...
      {kind === 'overview' ? (
        <>
          ...
          <section className="mt-7 space-y-4 rounded-2xl border border-slate-200 p-6">
            ...
            <Link href="/login/register" className="inline-flex rounded-lg bg-slate-950 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-slate-800">Create an account</Link>
          </section>
